...
> **Applied here:** A2. **Adopted but not yet reflected in this document's body:** A3, A4, A5, A6, A7, A13, A14. Where this document conflicts with the Amendment log, **the amendment log governs**; reconciling this body text is tracked as remaining editorial work.
